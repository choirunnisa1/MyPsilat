...
class PukulanSangkalActivity : AppCompatActivity() {
    private lateinit var contentTeknikAdapter: ContentTeknikAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pukulan_sangkal)
        setOnContentItems()
        setupIndicator()
        setCurrentIndicator(0)

        video_kuda_depan.settings.javaScriptEnabled = true
        video_kuda_depan.loadUrl("https://www.youtube.com/embed/dj5XbaB6ma4")
        ...
        contentTeknikAdapter = ContentTeknikAdapter(
                listOf(
                        ...
                        ContentItem(
                                ...
                                R.drawable.ps_lima,
                                "3(a)",
                                "Pukulan ini mengayun dengan tangan mengepal dari arah bawah luar badan ke arah sasaran di depan dengan kepalan tangan menghadap ke atas"
                        ),
                        ContentItem(
                                R.drawable.ps_enam,
                                R.drawable.ps_tujuh,
                        ...
                        ContentItem(
                                R.drawable.ps_delapan,
                                null,
                                "4",
                                "Posisi tangan yang tidak digunakan untuk memukul yaitu berada disamping pinggang mengepal menghadap ke atas"
                        ),
                        ContentItem(
                                R.drawable.ps_sembilan,
                                null,
                                "5",
