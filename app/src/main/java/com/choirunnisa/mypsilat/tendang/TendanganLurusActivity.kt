...
class TendanganLurusActivity : AppCompatActivity() {
    private lateinit var contentTeknikAdapter: ContentTeknikAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tendangan_lurus)
        setOnContentItems()
        setupIndicator()
        setCurrentIndicator(0)

        video_kuda_depan.settings.javaScriptEnabled = true
        video_kuda_depan.loadUrl("https://www.youtube.com/embed/qFjsrlEAKr4")
        ...
        contentTeknikAdapter = ContentTeknikAdapter(
                listOf(
                        ...
                        ContentItem(
                                ...
                                null,
                                "4",
                                "Bagian kaki yang kena saat menendang adalah pangkal bagian dalam jari – jari kaki dengan posisi badan menghadap ke sasaran\n"
                        ),
                        ContentItem(
                                R.drawable.tl_enam,
                                R.drawable.tl_tujuh,
